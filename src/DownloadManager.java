...
public class DownloadManager extends JFrame implements Observer {
	...
	private void actionAdd() throws IOException {
		...
		if (verifiedUrl != null) {
			...
			/*
			 * if(progressStatus.render==100) { Desktop desktop =
			 * Desktop.getDesktop(); File dirToOpen = null; try { dirToOpen =
			 * new File("C:\\Users\\asusrockz\\Desktop\\Ultimate Final OOAD");
			 * desktop.open(dirToOpen); } catch (IllegalArgumentException iae) {
